    ...
    $(document).ready(function() {
        ...
        $('#email').change(function() {
            ...
            // Check if the email is unique in the database.
                ...
                $('#email_alert').html('E-mailadres is al in gebruik.');
            }
            else {
                $('#email_alert').html('');
            }
        ...
        $('#submit').click(function() {
            ...
            if (data['email'].length <= 0 || !uniqueEmail(data['email'])) {
                $('#email_alert').html('Ongeldig e-mailadres.');
                error = true;
            }
            ...
            // If there wasn't an error with validation post the data to the server.
            if (error === false) {
                $.ajax({
                    type: 'POST',
                    data: data,
                    ...
                    success: function(response) {
                        // The content is replaced with the response.
